		      ...
		      struct fat_slot_info *sinfo)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_find\n");
...
static int msdos_hash(const struct dentry *dentry, struct qstr *qstr)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_hash\n");
		...
		unsigned int len, const char *str, const struct qstr *name)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_cmp\n");
			   ...
			   struct timespec *ts, struct fat_slot_info *sinfo)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_add_entry\n");
			...
			bool excl)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_create\n");
...
static int msdos_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_rmdir\n");
...
static int msdos_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_mkdir\n");
...
static int msdos_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "NAMEI_MSDOS: msdos_unlink\n");
