...
shortname:
	...
	de->size = 0;
	printk(KERN_INFO "NAMEI_VFAT: vfat_build_slots\n");
	sprintf(tmpbuf, "de->name= %s, de->attr= %u, de->lcase= %u\n", de->name, de->attr, de->lcase);
				  ...
				  unsigned int flags)
{
	...
	printk(KERN_INFO "NAMEI_VFAT: vfat_lookup\n");
		       ...
		       bool excl)
{
	...
	printk(KERN_INFO "NAMEI_VFAT: vfat_create\n");
...
static int vfat_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "NAMEI_VFAT: vfat_rmdir\n");
...
static int vfat_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "NAMEI_VFAT: vfat_unlink\n");
...
static int vfat_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	printk(KERN_INFO "NAMEI_VFAT: vfat_mkdir\n");
		       ...
		       unsigned int flags)
{
	...
	printk(KERN_INFO "NAMEI_VFAT: vfat_rename\n");
